...
<h2>Model</h2>
odilon-model contains classes (in particular the JSON Model) used by both <a href="https://github.com/atolomei/odilon-client" target="_blank">odilon-server</a> and  <a href="https://github.com/atolomei/odilon-client" target="_blank">odilon-client</a>
