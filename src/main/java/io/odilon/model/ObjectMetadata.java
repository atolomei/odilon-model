...
/**
 * <p>
 * Object's metadata (excluding the binary file) used both by the Odilon Server
 * and Odilon Java SDK client.
 * </p>
 * 
...
public class ObjectMetadata extends OdilonModelObject implements Serializable {
	...
	/**
	 * length in bytes of the file stored on disk by the server. If the file is
	 * stored not encrypted this value is the same as the source file length.
	 * Otherwise, this value is slighthly higher than the source file length
	 * (sourceLength)
	 */
	@JsonProperty("length")
	public long length;
