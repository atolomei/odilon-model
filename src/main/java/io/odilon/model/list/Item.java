 ...
 * 
 * <p>
 * Wrapper for Lists and other {@link Iterable} structures where some elements
 * may not be an instance of {@code T} but an error
 * </p>
 * 
 * <p>
 * Iterators shoud check the value of {@code isOk()} before using the instance
 * of {@code T} contained in the Item.
 * </p>
 * 
 * 
 * <p>
