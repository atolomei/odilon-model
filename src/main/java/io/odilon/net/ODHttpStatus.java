...
public enum ODHttpStatus {
	...
	public String toJSON() {
		return  "\"value\":"+String.valueOf(this.value)+
				", \"series\":"+String.valueOf(this.series)+ 
				", \"reasonPhrase\":"+(Optional.of(reasonPhrase).isPresent()? ("\""+reasonPhrase+"\""):"null" +
				", \"moreInfo\":\"https://en.wikipedia.org/wiki/List_of_HTTP_status_codes\"");
	}
	 ...
	 * <p>Retrievable via {@link ODHttpStatus#series()}.
	 */
	public enum Series {
		 ...
		 * @return the {@code Series} enum constant for the supplied {@code HttpStatus}
		 * @deprecated as of 5.3, in favor of invoking {@link ODHttpStatus#series()} directly
		 */
		@Deprecated
